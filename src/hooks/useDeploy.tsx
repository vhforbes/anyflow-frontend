...
const [requestOne, setRequestOne] = useState({} as RequestProps);
const [requestTwo, setRequestTwo] = useState<RequestProps>();

if (requestOne) {
  return <div>RequestOne</div>;
}

if (requestTwo) {
  return <div>RequestTwo</div>;
}
